                        ...
                        <div class="col-xl-3">
                            <form action="{{ route('shopList') }}" method="get">
                                <div class="input-group w-100 mx-auto d-flex">
                                    <input type="search" class="form-control p-3" value="{{ request('searchKey')}}" name="searchKey" placeholder="keywords">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <form action="{{ route('shopList')}}" method="get">
                                            @csrf
                                            <input type="text" placeholder="Minium Price" value="{{ request('minPrice')}}"  name="minPrice" class="form-control my-2">
                                            <input type="text" placeholder="Maxium Price"  value="{{ request('maxPrice')}}" name="maxPrice" class="form-control my-2 ">
